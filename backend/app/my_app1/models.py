...
def promote_performance(performance):
    ...
    with transaction.atomic():
        ...
        # Идемпотентность обеспечивается флагами roles_propagated /
        # director_propagated, поэтому раннего выхода нет: это позволяет
        # «докатить» режиссёра, если его назначили уже после перевода.
